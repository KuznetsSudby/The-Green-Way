...
@Suppress("unused")
class CustomTouchImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : AppCompatImageView(context, attrs, defStyle) {
    /**
    ...
    var currentZoom = 0f
        set(value) {
            field = value
            changeZoomListener?.changedZoom(value)
        }
    ...
    var changeZoomListener: ChangeZoomListener? = null
     ...
     * and ScaleType.
     */
    fun setZoom(img: CustomTouchImageView) {
...
interface ChangeZoomListener{
    fun changedZoom(zoom: Float)
}